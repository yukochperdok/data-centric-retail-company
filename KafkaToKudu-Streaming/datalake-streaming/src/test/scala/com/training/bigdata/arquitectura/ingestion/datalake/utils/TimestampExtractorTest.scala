...
class TimestampExtractorTest extends FlatSpec with Matchers {
  ...
  "getTimestamp" should "fail with invalid formats" in {
    an [DataException] should be thrownBy extractor.getTimestamp("19/12/2018 23:00:00")
    an [DataException] should be thrownBy extractor.getTimestamp("19/12/2018")
    an [DataException] should be thrownBy extractor.getTimestamp("2018.12.19")
    an [DataException] should be thrownBy extractor.getTimestamp("")
  }
