...
object ZipCodesStreetMapRunnerTest extends FlatSpec with Matchers with DockerTestKit with DockerKitDockerJava with DockerKuduService {
...
@CucumberOptions(
  features = Array("classpath:features/INEFilesIngestion"),
  glue = Array("classpath:com/training/bigdata/mdata/INEaddresses/acceptance/INEFilesIngestion"),
  tags = Array("@acc"),
  monochrome = true,
  plugin = Array("pretty",
...
class ZipCodesStreetMapRunnerTest
